...
namespace Pracowniki
{
    public class Inzynier
    {
       public enum Skutecznosc
        ...
        public static int liczbaInzynierow;
        public string imie;
        ...
        public void obniz()
        {
            if (liczbaProjektow < 10 && skutecznosc == Skutecznosc.DOBRY)
            {
                skutecznosc = Skutecznosc.SLABY;
            }
            else if (liczbaProjektow <= 20 && skutecznosc == Skutecznosc.WYBITNY)
            {
                skutecznosc = Skutecznosc.DOBRY;
            }
        }
